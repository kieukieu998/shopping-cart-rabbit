  ...
  return (
    <section className="py-16 px-4 lg-px:0">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
        {/* Left Content  */}
        <div className="lg:w-1/2 p- text-center p-8 lg:text-left">
          <h2 className="text-lg font-semibold text-gray-700 mb-2">Comfor and Style</h2>
        ...
        <div className="lg:w-1/2">
          <img src={featuredImage} alt="Featured Collection" className="w-full h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl"/>
        </div>
      </div>
